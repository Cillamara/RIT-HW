...
pairs AS (
  SELECT
    ABS(ci.scaled_dim_1 - cj.scaled_dim_1) +
    ABS(ci.scaled_dim_2 - cj.scaled_dim_2) +
    ABS(ci.scaled_dim_3 - cj.scaled_dim_3) +
    ABS(ci.scaled_dim_4 - cj.scaled_dim_4) +
    ABS(ci.scaled_dim_5 - cj.scaled_dim_5) +
    ABS(ci.scaled_dim_6 - cj.scaled_dim_6) +
    ABS(ci.scaled_dim_7 - cj.scaled_dim_7) AS d
